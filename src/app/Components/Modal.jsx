...
export const paintings = [
    ...
    { id: 31, title: "Acrylic Painting on canvas (glass framed)", price: "700/-", size: "9x7 inches", description: "The image shows a framed artwork with a green-dominated background and floral elements. The frame is black, providing a contrasting border to the colorful painting. The lower right corner of the painting contains a signature." },
