        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-10">
          <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
              ...
              <Button className="w-full bg-[#942972] hover:bg-[#7b1d5e]">Request a Painting</Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
              ...
              <Button className="w-full bg-[#942972] hover:bg-[#7b1d5e]">Design Your Jewelry</Button>
            </div>
          </div>
          ...
          <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-shadow">
            ...
            <div className="p-6">
              ...
              <Button className="w-full bg-[#942972] hover:bg-[#7b1d5e]">Order Custom Decor</Button>
            </div>
          </div>
        </div>
