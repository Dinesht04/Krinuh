...
export const paintings = [
  ...
  },
  {
    ...
    size: "9x7 inches",
    description:
      "The image shows a framed artwork with a green-dominated background and floral elements. The frame is black, providing a contrasting border to the colorful painting. The lower right corner of the painting contains a signature.",
  },
  {
    id: 31,
    title: "Acrylic Painting on canvas (glass framed)",
    ...
    size: "9x7 inches",
    description:
      "The image depicts a framed painting of a vibrant nature scene. The foreground is filled with bright yellow flowers and lush green foliage. In the background, there are distant mountains under a clear blue sky with a few scattered clouds. The painting is signed by the artist, whose name is 'Shweta Tyagi' in the bottom right corner. The frame is black and has a simple, clean design. The overall composition conveys a sense of natural beauty and tranquility.",
  },
  {
    id: 32,
    title: "Acrylic Painting on canvas (glass framed)",
